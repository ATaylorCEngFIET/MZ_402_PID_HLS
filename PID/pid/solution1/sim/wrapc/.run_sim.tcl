...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "PID.autotvin.dat"
	set constFileTvOut       "PID.autotvout.dat"
	set constFileHdlTvIn     "PID.autohdltvin.dat"
	set constFileHdlTvOut    "PID.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
