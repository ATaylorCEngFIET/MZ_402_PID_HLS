...
// wrapc file define:
#define AUTOTB_TVIN_ts "../tv/cdatafile/c.PID.autotvin_ts.dat"
#define AUTOTB_TVOUT_ts "../tv/cdatafile/c.PID.autotvout_ts.dat"
// wrapc file define:
#define AUTOTB_TVIN_pmax "../tv/cdatafile/c.PID.autotvin_pmax.dat"
#define AUTOTB_TVOUT_pmax "../tv/cdatafile/c.PID.autotvout_pmax.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_ts "../tv/rtldatafile/rtl.PID.autotvout_ts.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_pmax "../tv/rtldatafile/rtl.PID.autotvout_pmax.dat"
...
string get_depth_list () {
  ...
  total_list << "{ts " << ts_depth << "}\n";
  total_list << "{pmax " << pmax_depth << "}\n";
...
extern "C" float PID_hw_stub_wrapper(float, float, float, float, float, float, float);
...
//ts
aesl_fh.touch(AUTOTB_TVIN_ts);
aesl_fh.touch(AUTOTB_TVOUT_ts);
//pmax
aesl_fh.touch(AUTOTB_TVIN_pmax);
aesl_fh.touch(AUTOTB_TVOUT_pmax);
...
// print ts Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_ts, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_ts);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_ts, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.ts_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_ts, __xlx_sprintf_buffer.data());
}
// print pmax Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_pmax, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_pmax);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_pmax, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.pmax_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_pmax, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
float ap_return = PID_hw_stub_wrapper(__xlx_apatb_param_set_point, __xlx_apatb_param_KP, __xlx_apatb_param_KI, __xlx_apatb_param_KD, __xlx_apatb_param_sample, __xlx_apatb_param_ts, __xlx_apatb_param_pmax);
